...
(setq
 ...
 '((symbol (&rest x) (seq symbol-start (or x) symbol-end))
   ...
   (up-to-9-variables
    (seq (group-n 1 name) ws
         (? "," ws (group-n 2 name) ws
            (? "," ws (group-n 3 name) ws
               (? "," ws (group-n 4 name) ws
                  (? "," ws (group-n 5 name) ws
                     (? "," ws (group-n 6 name) ws
                        (? "," ws (group-n 7 name) ws
                           (? "," ws (group-n 8 name) ws
                              (? "," ws (group-n 9 name) ws))))))))))))
